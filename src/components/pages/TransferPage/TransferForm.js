                    ...
                    <form onSubmit={submithandler} className='inputfrom' id='loginfrom'>
                        <div className='inside-form-from'>
                            ...
                            <div className='form-ele-from'>
                                <input type='text' name='facc' id='facc' className='facc' placeholder='Enter Acc Number' onKeyUp={getrohith} onChange={e =>{ setformdet({...formdet, facc: e.target.value})}}  pattern="[1-9]{1}[0-9]{13}"title="Please enter exactly 10 digits" value={formdet.facc} required/>
                            </div>
                            <div className='form-ele-from'>
                            ...
                            <div className='form-ele-from'>
                                <input type='text' name='famt' id='famt' className='famt' placeholder='Enter Amount' onKeyUp={getaditya} onChange={e => setformdet({...formdet, famt: e.target.value})} value={formdet.famt} required/>
                            </div>
